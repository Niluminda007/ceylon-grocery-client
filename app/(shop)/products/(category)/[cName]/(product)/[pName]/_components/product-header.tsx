...
//   return (
//     <div className="flex flex-col lg:flex-row items-center gap-8 animate-fadeIn p-6 rounded-lg">
...
//             <div
//               className="rounded-lg bg-neutral-200 text-xs p-2 font-medium shadow-md flex items-center justify-center text-neutral-950"
//               key={index}
//             >
//               {tag}
//             </div>
