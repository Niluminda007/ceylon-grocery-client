export const initialProducts = [
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Finely ground pepper powder, known for its bold and sharp flavor, perfect for enhancing the taste of your dishes. Ideal for seasoning meats, soups, and salads, this spice adds a pungent kick to any recipe.",
    weight: "50g",
    inStock: true,
    stockCount: 10,
    category: "Spices",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "A perfectly blended mix of spices for creating authentic Buriyani dishes. This mix brings out the rich, aromatic flavors essential for traditional Buriyani, making it easy to prepare a delicious and flavorful meal.",
    weight: "50g",
    inStock: true,
    stockCount: 10,
    category: "Spices",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "A crunchy and flavorful mix of roasted peanuts and aromatic curry leaves, seasoned to perfection. This savory snack offers a delightful blend of textures and spices, perfect for a quick bite or as an accompaniment to your meals.",
    weight: "350g",
    inStock: false,
    stockCount: 0,
    category: "Packaged Foods",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "MDK Thosai Mix brings you the authentic taste of traditional South Indian dosa in a convenient ready-to-make form. Just add water, and you'll have crispy, golden dosas ready to serve. Perfect for breakfast or a light dinner, this mix saves time while delivering delicious results every time.",
    weight: "400g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Maggie Coconut Milk Powder is a quick and easy way to enjoy the rich, creamy taste of coconut milk. Perfect for curries, desserts, and beverages, just mix with water to create the desired consistency. A must-have for adding tropical flavor to any dish.",
    weight: "125g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Marmite is a unique, savory spread loved by millions worldwide. Made from yeast extract, this rich and umami-packed spread is perfect on toast, in sandwiches, or as an ingredient in cooking. Its bold flavor is an acquired taste but a staple in many households.",
    weight: "50g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "This Caramel Pudding Mix makes it easy to create a smooth, creamy, and indulgent dessert in minutes. With its rich caramel flavor and velvety texture, it's the perfect treat for any occasion. Simply add milk, cook, and chill to enjoy a delicious homemade pudding.",
    weight: "100g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Murukku Bite is a crunchy, savory snack that's perfect for any time of day. Made from rice flour and spices, this traditional Sri Lankan snack is deliciously addictive and great for sharing. Enjoy the authentic taste of Sri Lankan cuisine with Murukku Bite.",
    weight: "100g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Jack Mackerel is a nutritious and flavorful fish, perfect for creating a variety of dishes. Rich in omega-3 fatty acids, this canned mackerel is versatile and can be used in curries, salads, or on its own. A convenient way to enjoy healthy and delicious seafood.",
    weight: "200g",
    inStock: true,
    stockCount: 10,
    category: "Other Items",
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Dry Sprats (Halmasso) are a staple in many Sri Lankan kitchens, known for their rich flavor and crunchy texture. Perfect for frying or adding to curries, these small dried fish are packed with protein and offer a unique taste to your dishes. A versatile ingredient that brings a burst of umami to any meal.",
    weight: "200g",
    inStock: true,
    stockCount: 10,
  ...
  },
  {
    ...
    salePrice: -1,
    description:
      "Dried Fish (Katta Karawala) is a flavorful and traditional Sri Lankan ingredient, known for its intense taste. Ideal for making spicy curries or sambols, this dried fish adds depth and a rich umami flavor to your dishes. A must-have for those who enjoy the authentic taste of Sri Lankan cuisine.",
    weight: "200g",
    inStock: true,
    stockCount: 10,
    category: "Dry Fish Items",
